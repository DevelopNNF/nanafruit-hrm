    ...
    children: [
      ...
      { path: 'employees/:id', element: <KeyedEmployeeForm /> },
      {
        ...
        children: [
          ...
          // Both before nothing in particular — 'import'/'imports' are
          // literal segments and 'attendance' has no :id child to shadow.
      ...
      {
        element: <RequireRole role={['HRM.Admin', 'HRM.Payroll']} />,
        children: [
